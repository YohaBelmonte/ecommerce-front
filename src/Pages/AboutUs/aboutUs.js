  ...
  return (
    ...
    <div>
      ...
      <div className="container-navbar w-100">
        <div className="row mx-4 navbar-about d-flex justify-content-center">
          <div className="col-lg-1 col-sm-12 mx-5"> <Link to="/" className='nav-about'>VISIÓN</Link>  </div>
          <div className="col-lg-1 col-sm-12 mx-5"> <Link to="/" className='nav-about'>MATERIALES</Link>  </div>
          <div className="col-lg-1 col-sm-12 mx-5"> <Link to="/" className='nav-about'>UBICACIÓN</Link> </div>
          <div className="col-lg-1 col-sm-12 mx-5"> <Link to="/" className='nav-about'>CERTIFICADOS</Link> </div>
          <div className="col-lg-2 col-sm-12 mx-5"> <Link to="/" className='nav-about'>IMPACTO AMBIENTAL</Link> </div>
          <div className="col-lg-2 col-sm-12"> <Link to="/" className='nav-about'>NUESTRO EQUIPO</Link> </div>
        </div>
      </div>
          ...
          <div className="ListMaterials">
            <ul >
              <li className="listMat">
                <Link to="/" className='styleIcons d-flex'> <FontAwesomeIcon icon={faPlus} className='iconoPlus mt-lg-4' />   <p className="mx-lg-2" >  Lana reciclada </p> </Link>
                <a href="#" className='styleIcons d-flex' > <FontAwesomeIcon icon={faPlus} className='iconoPlus mt-lg-4' /> <p className="mx-lg-2" >  Lana reciclada </p></a>
              </li>
              <li className="listMat">
                <a href="#" className='styleIcons d-flex' > <FontAwesomeIcon icon={faPlus} className='iconoPlus mt-lg-4' /> <p className="mx-lg-2" >  Algodón reciclada </p></a>
              </li>
              <li className="listMat">
                <a href="#" className='styleIcons d-flex' > <FontAwesomeIcon icon={faPlus} className='iconoPlus mt-lg-4' /> <p className="mx-lg-2" >  Poliester reciclada </p></a>
              </li>
              <li className="listMat">
                <a href="#" className='styleIcons d-flex' > <FontAwesomeIcon icon={faPlus} className='iconoPlus mt-lg-4' /> <p className="mx-lg-2" >  Caucho reciclado </p></a>
              </li>
            </ul>
          </div>
