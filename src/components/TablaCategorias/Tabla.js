    ...
    <div className="container-fluid">
      <div className="crud shadow-lg p-3 my-5 bg-dark">
        <div class="row ">
          ...
          <div class="col-sm-3 offset-sm-2 mt-5 mb-4 text-gred text-white"><h2><b>PRODUCTOS</b></h2></div>
            ...
            <table class="table table-striped table-hover table-bordered  bg-light">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>USA</td>
                  <td>
                    <a class="view" title="View" data-toggle="tooltip" style={{ color: "#10ab80" }}><i class="material-icons">&#xE417;</i></a>
