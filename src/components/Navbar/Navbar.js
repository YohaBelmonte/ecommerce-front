        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="link-navbar mt-4">
            <li className='container-link'>
              <Link to="/" className='link-nav mx-lg-4 mt-lg-3'>INICIO</Link>
              <Link to="/male" className='link-nav'>MASCULINO</Link>
              <Link to="/famele" className='link-nav mx-lg-4'>FEMENINO</Link>
              <Link to="/aboutUs" className='link-nav'>SOBRE NOSOTROS</Link>
              <Link to="/contact" className='link-nav mx-lg-4'>CONTACTO</Link>
              {isAdmin ? (
